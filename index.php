	...
	<div id="wrapper" class="home-page"> 
		...
		<section class="projects">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="aligncenter"><h2 class="aligncenter">Our Featured Hostels</h2> <br/></div>
						<br/>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="section-title text-center">
							<h2>Our Students</h2>
							<p>We maintain strict rules for the safety and security of our students.</p>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-6 col-sm-6">
						<div class="about-text">
							<h3>About Us</h3>
							<p>Hostel Dynamo was founded in 2011.</p>
